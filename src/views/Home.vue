    ...
    <div class="sm:basis-3/4 w-80">
      ...
      <div class="w-full text-center">
        <button
          ...
          v-if="rickyMortyData.dataCopy.length > 0"
      ...
      <div v-if="rickMortyDataResult.length == 0">No Cards to Display</div>
    </div>
  </div>
</template>
...
const rickMortyDataResult = computed(() => store.state.rickyMortyObj.dataCopy);
